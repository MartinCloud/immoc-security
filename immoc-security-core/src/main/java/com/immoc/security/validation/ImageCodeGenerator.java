...
public class ImageCodeGenerator implements ValidateCodeGenerator {
    ...
    public ImageCode generate(ServletWebRequest request) {
        int width = ServletRequestUtils.getIntParameter(request.getRequest(), "width", securityProperties.getValidationCodeProperties().getImage().getWidth());
        int height = ServletRequestUtils.getIntParameter(request.getRequest(), "height", securityProperties.getValidationCodeProperties().getImage().getHeight());
